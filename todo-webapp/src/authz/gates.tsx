...
// This app installs "react-router" (v7's unified package, per
// oxygen-ui-design-system's setup script), not "react-router-dom" — v7
// exports these DOM bindings from the base package, so the import is adapted
// from the asset's "react-router-dom" without changing any export name below.
